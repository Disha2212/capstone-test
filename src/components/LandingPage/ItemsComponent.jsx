...
import black_tshirt from "../../assets/images/black_tshirt.jpg";
import blackhoodie from "../../assets/images/blackhoodie.jpg";
import whitetshirt from "../../assets/images/whitetshirt.jpg"; // Fix the typo here
const pics_array = [black_tshirt, blackhoodie, whitetshirt];
...
const CardComponent = ({ product,index }) => {
    return (
